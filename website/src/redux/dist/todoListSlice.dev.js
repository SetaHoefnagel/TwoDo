...
exports["default"] = exports.deleteTodo = exports.toggleComplete = exports.addTodo = exports.todoListReducer = exports.deleteTodoAsync = exports.toggleCompleteAsync = exports.addTodoAsync = exports.getTodosAsync = void 0;
...
var getTodosAsync = (0, _toolkit.createAsyncThunk)('todos/getTodosAsync', function _callee() {
  var resp, todos;
...
var addTodoAsync = (0, _toolkit.createAsyncThunk)('todos/addTodoAsync', function _callee2(payload) {
  var resp, todo;
...
var toggleCompleteAsync = (0, _toolkit.createAsyncThunk)('todos/completeTodoAsync', function _callee3(payload) {
  var resp, todo;
...
var deleteTodoAsync = (0, _toolkit.createAsyncThunk)('todos/deleteTodoAsync', function _callee4(payload) {
  var resp;
...
var todoListReducer = (0, _toolkit.createSlice)({
  name: 'todos',
  initialState: [],
  reducers: {
...
exports.todoListReducer = todoListReducer;
var _todoListReducer$acti = todoListReducer.actions,
    addTodo = _todoListReducer$acti.addTodo,
    toggleComplete = _todoListReducer$acti.toggleComplete,
    deleteTodo = _todoListReducer$acti.deleteTodo;
exports.deleteTodo = deleteTodo;
exports.toggleComplete = toggleComplete;
exports.addTodo = addTodo;
var _default = todoListReducer.reducer;
